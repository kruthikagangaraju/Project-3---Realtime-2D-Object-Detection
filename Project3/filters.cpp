...
int customfilters::alternativegreyscale(cv::Mat& src, cv::Mat& dst) {
	// Convert destination to single channel
	dst = Mat(src.rows, src.cols, CV_8UC1);
